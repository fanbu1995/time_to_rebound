...
```{r univariate Cox PH model, echo=F}
...
One natural of extending the previously chosen univariate model is to find the best "addtional" predictor. Thus, an exhaustive search 
